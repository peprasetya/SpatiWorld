...
# SpatiWorld Installation Script
...
DEFAULT_SYSTEM_INSTALL_DIR="/opt/spatiworld"
DEFAULT_USER_INSTALL_DIR="$HOME/spatiworld"
...
# Function to install SpatiWorld to the specified directory
install_to_prefix() {
    ...
    echo " - Installing SpatiWorld to $install_prefix"
...
homedir_install() {
    ...
    warn "to install SpatiWorld in your home directory. If you"
    warn "would like to install SpatiWorld system-wide, please run"
...
main() {
    echo "Starting SpatiWorld installation script..."
    ...
    echo "SpatiWorld installation process completed successfully."
}
